      ...
      <ndc-form-item label="文件夹名称" required>
        <u-validator name="folderName" :validate="errors">
          <input type="text" class="ndc-input"
            ...
            autocomplete="off"
            placeholder="1-64个字符，支持中文、字母、数字、- 和 _"
            v-validate="{
              required: '文件夹名称',
              nameValidator: true
            }"
...
<!--      选择新建文件夹类型-->
      <ndc-form-item label="文件夹类型" required>
...
@Component
export default class MFolderModalV3 extends Mixins(ModalMixin) {
