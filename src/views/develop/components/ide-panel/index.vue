...
`
  ...
  private async confirmRelease() {
    ...
    const releaseHref = `${releaseBaseUrl}#/htds_dsw/flink/release?projectName=${projectName}&projectId=${projectId}&userId=${userId}&roleId=${roleId}&roleID=${roleID}&jobId=${jobId}&taskName=${taskName}`
