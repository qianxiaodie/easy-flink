...
export default class MMetadataNav extends Mixins(navMixin) {
  @State('metadataList', MODULE_NAMESPACE.develop_v3)
  ...
  private create(metadata: any = {}, isEdit: boolean = false) {
    ...
    this.metadataInstance && this.metadataInstance.show(Object.assign({}, metadata, {
      isEdit,
      types: Object.keys(this.metadataList)
    }), async (args: any) => {
      try {
        const data = isEdit ? Object.assign({}, args, {
          metaId: metadata.id
        }) : args;
